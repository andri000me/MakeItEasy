    ...
    <div class="container">
        ...
        <br />
              ...
              <div class="row">
                  ...
                  <div class="col-md-2">
                      <button id="btn_date" class="btn btn-info" style="margin-top: 25px">Cek Transaksi</button>
                  </div>
              </div>
        ...
        <button class="btn btn-success" onclick="notification()"><i class="glyphicon glyphicon-plus"></i> Add Person</button>
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Coba/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
 
            $('[name="id"]').val(data.id_petani);
                ...
                <form action="#" id="form" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="desa" placeholder="Desa" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="saldo" placeholder="Saldo" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
