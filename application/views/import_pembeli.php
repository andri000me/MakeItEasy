      ...
      <div class="col-md-12">
        <div class="box" style="border: 2px solid #dff0d8;">
          <div class="box-header">
            <h3 class="box-title">Masukkan Data Pembeli melalui Excel </h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              <div class="col-md-6">
                <form method="post" action="" enctype="multipart/form-data">
                  <a href="<?php echo base_url();?>/assets/FormatImportPembeli.xlsx" class="btn btn-app">
...
<script>
  $(document).ready(function(){
    ...
    {
        $.ajax({
          url:"<?php echo base_url(); ?>Import_Pembeli/fetch",
          method:"POST",
    ...
    $('#import_form').on('submit', function(event){
      ...
      $.ajax({
        url:"<?php echo base_url(); ?>Import_Pembeli/import",
        method :"POST",
