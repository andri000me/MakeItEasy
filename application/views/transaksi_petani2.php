                    ...
                    <div class="box box-solid" style="border: 2px solid #f0f0f0;">
                      ...
                      <div class="box-body" style="text-align: center;">
                        <div class="btn-group-vertical btn-block">
                          ...
                          <button type="button" class="btn btn-setor-ver bg-yellow-gradient""> <i class="fa fa-user-plus"></i> Tambah petani</button>
                        </div>
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="box box-solid" style="border: 2px solid #f0f0f0;">
                      ...
                      <!-- /.box-header -->
                      <div class="box-body" >
                        <span class="label label-danger text-danger"><i class="fa fa-calendar-times-o"></i> </span>: Sudah melebihi batas pembayaran <br>
                        <span class="label label-warning text-warning"><i class="fa fa-warning"></i> </span> : Mendekati batas pembayaran <br>
                        <span class="label label-success text-success"><i class="fa fa-calendar-check-o"></i> </span> : Masih aman  <br>
                      </div>
                      <!-- /.box-body -->
                    </div>
                  </div>
                    ...
                    <div class="modal-dialog modal-lg">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title">Input BON</h4>
                        </div>
                        ...
                        <table id="tabel_bon" class="table table-bordered table-striped DataTable" style="font-size: 15px">
                          <thead>
                            <tr class="bg-info">
                              ...
                              <th style="text-align: center; line-height: 50px">ID Petani</th>
                              ...
                              <th style="text-align: center; line-height: 50px">Batas Bayar</th>
                          ...
                          <tbody>
                            <?php $no=1; foreach ($tb_transaksi as $tb): ?>
                              <tr>
                                ...
                                <td><?= $tb->berat_bs ?></td>
                                <td><?= $tb->berat_kotor-$tb->berat_bs?></td>
                                <td><span class="label label-danger"><i class="fa fa-calendar-times-o"></i></span>
                                    <span class="label label-warning"><i class="fa fa-warning"></i></span>
                                    <span class="label label-success"><i class="fa fa-calendar-check-o"></i></span></td>
                              </tr>
                            <?php $no++; endforeach ?>
                          </tbody>
                        </table>
