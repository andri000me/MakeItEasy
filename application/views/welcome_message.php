...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function tampil_data_barang(){
            $.ajax({
                type  : 'ajax',
                url   : '<?php echo base_url()?>Datatabel/data_barang',
                async : false,
                dataType : 'json',
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('Datatabel/get_barang')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(id, barang, harga){
                        $('#ModalaEdit').modal('show');
                        $('[name="kobar_edit"]').val(data.id);
                        $('[name="nabar_edit"]').val(data.barang);
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('Datatabel/simpan_barang')?>",
                dataType : "JSON",
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('Datatabel/update_barang')?>",
                dataType : "JSON",
                data : {kobar:kobar , nabar:nabar, harga:harga},
                success: function(data){
                    $('[name="kobar_edit"]').val("");
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
            type : "POST",
            url  : "<?php echo base_url('Datatabel/hapus_barang')?>",
            dataType : "JSON",
                    data : {kode: kode},
                    success: function(data){
